...
namespace CommandAPI.Tests
{
    public class CommandsControllerTests : IDisposable
    {
        ...
        */
        ...
        // второй пример
        // Этот тест проверяет, вернули ли мы CommandReadDto. 
        // Что касается проверки действительности нашего внешнего контракта, 
        // то мне очень нравится этот тест. Если мы изменим код нашего контроллера, 
        // чтобы вернуть другой тип, этот тест завершится неудачей, 
        // что выявит потенциальную проблему с нашим контрактом – очень полезно.
        [Fact]
        public void GetCommandByID_Returns200OK__WhenValidIDProvided()
        {
            //Arrange
